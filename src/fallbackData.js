export const profile = {
    ...
    aboutTitle: "About Me",
    aboutContent: "Hello! I’m Eyobed—a developer who crafts digital experiences with purpose. My fascination began when I first merged logic and creativity through code. Today, I build full-stack applications that balance elegant interfaces with resilient backends, fueled by a love for problem-solving and a drive to make technology meaningful.\n\nFast-forward to today, and I’ve had the privilege of working at national cybersecurity agency, a start-up, a huge corporation, and a student-led design studio. My main focus these days is building accessible, inclusive products and digital experiences.",
    aboutImage: "https://endpoint.eyobedelias.net.et/uploads/1777320352001-49544608.jpg",
    aboutSkills: [
...
export const jobs = [
    {
        ...
        html: "<ul><li>Lead technical innovation and software architecture for a high-traffic travel platform.</li><li>Manage engineering teams and implement scalable infrastructure using Node.js and AWS.</li></ul>"
    }
];
...
export const projects = [
    {
        ...
        html: "<p>A high-security authentication gateway implemented for national systems.</p>"
    }
];

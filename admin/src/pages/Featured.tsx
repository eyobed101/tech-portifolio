    ...
    return (
        <div className="space-y-6">
            <div className="flex justify-between items-center">
                <h2 className="text-xl font-semibold text-white">Manage Featured Projects</h2>
                <button
                    onClick={handleAdd}
                ...
                <table className="w-full text-left min-w-[800px]">
                    ...
                    <tbody className="divide-y divide-[#1f2937]">
                        {loading ? (
                            ...
                            <tr><td colSpan={3} className="px-6 py-8 text-center text-gray-500">No featured projects found.</td></tr>
                        ) : (
            ...
            <Modal
                ...
                title={selectedProject ? 'Edit Featured' : 'Add New Featured'}
            >
                <FeaturedForm
